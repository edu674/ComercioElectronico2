...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 24-03-2022 a las 19:29:32
...
INSERT INTO `productos` (`id_producto`, `id_provedor`, `nombre`, `categoria`, `cantidad`, `descripcion`, `imagen`, `precio`, `carrusel`) VALUES
(1, 1, 'Ajax-Desinfectante en polvo', '1', 17, 'Desinfectante en polvo de la marca Ajax en su presentacion de 388grms', 'ajax.png', 25, 0),
(2, 1, 'Detergente Arcoiris', '1', 23, 'Detergente de la marca arcoiris en su presentacion de 900grms', 'Arcoiris.png', 18, 0),
(3, 1, 'Atomizador', '1', 24, 'Atomizar pequeño efectivo para rociar agua o culaquier liquido en su interior', 'atomizador.png', 15, 0),
(4, 1, 'Blanqueador', '1', 24, 'Blanqueador liquido en su presentacion de 962ml', 'blanqueador.png', 12, 0),
(5, 1, 'Cepillo Escoba', '1', 22, 'Cepillo Escoba multiusosos con cerdas de resistentes a cualquier superficie', 'cepilloescoba.jpeg', 45, 0),
(6, 1, 'Fibra', '1', 21, 'fibra multiusosos ideal para cualquier superficie', 'fibra.png', 8, 0),
(7, 1, 'Fibra Metalica', '1', 24, 'Fibra de metal ideal para lavar platos, caserolas entre otros', 'fibra_metalica.png', 11, 0),
(8, 1, 'Fibra Verde', '1', 25, 'fibra de uso multiple ideal para enjuagar cualquer superficie', 'fibra_verde.png', 10, 0),
(9, 1, 'franela', '1', 25, 'Franela ultrasueve idel para limpiar ciualquier superficie', 'franela.png', 18, 0),
(10, 1, 'jerga', '1', 24, 'Jerga de tela idela para limpiar cualquier tipo de superficie', 'jerga.png', 25, 0),
(11, 1, 'Limpia Vidrios', '1', 24, 'Limpia vidiros estilo escoba, idela para limpiar cualquier tipo de crital del hogar o de vehiculos personales', 'limpiaVidrios.png', 45, 0),
(12, 1, 'Pastillas de Cloro', '1', 24, 'Pastillas de cloro ideal para usar en el wc gracias a su gran capacidad de disolvsion, se garatiza hasta 20 descargas de agua, manteniendo tu baño limpio!', 'pastillas_cloro.png', 12, 0),
(13, 1, 'Recogedor', '1', 23, 'Recogedor de basura platico, de la marca Klintek', 'recogedor.png', 16, 0),
(14, 1, 'Recogedor Metalico', '1', 25, 'Recogedor metalico de uso multiple', 'recogedor_metalico.png', 25, 0),
(15, 1, 'Cepillo', '1', 9, 'Cepillo de plastico con fibras resistentes a cualquier superficie.', 'cepillo.png', 11, 0),
(16, 1, 'Cubeta plastica', '1', 20, 'Cubeta hecha de platico duro, ideal para cualquier tipo de trabajo duro', 'cubeta.png', 13, 0),
(17, 1, 'Bolsa de Basura', '1', 20, 'bolsa de basura grande de excelente claidad soporta un total de 30 kilos!', 'bolsa_basura.png', 5, 0),
(18, 1, 'Destapa Inodoros', '1', 20, 'bomba de hule ideal para destapar cualquier tipo de baño gracias a su diseño ergonomico y su gran calidad de material de hule', 'bomba_hule.png', 25, 0),
(19, 1, 'Bote de Basura', '1', 20, 'bote de basura con tapa par evitar la fuga de malos olores', 'bote_basura.png', 38, 0),
(20, 1, 'Bote de basura chico', '1', 20, 'bote de basura pequeño ideal para la cocina, el baño o cualquier habitacion del hogar!', 'bote_basura_chico.png', 25, 0),
(21, 1, 'Cepillo para auto', '1', 20, 'ceillo para lavar autos de excelente calidad, gracias a sus excelentes cerdas de gran soporte!', 'cepillo_auto.png', 41, 0),
(22, 1, 'Cepillo para baño', '1', 19, 'cepillo para limpiar el interior del inodoro', 'cepillo_baño.png', 15, 0),
(23, 1, 'Cepillo Escobetilla', '1', 20, 'Cepillo en forma de eescobetilla de excelente calidad', 'cepillo_escobetilla.png', 12, 0),
(24, 1, 'Tendedero', '1', 20, 'Lazo de Tenedero de gran calidad, soporta mas de 80 kilos!', 'tendedero.png', 36, 0),
(25, 1, 'Cepillo Industrial', '1', 20, 'cepillo de cerdas gruesas y restintes de uso industrial', 'cepillo_industrial.png', 52, 0),
(26, 1, 'Cepillo de mano', '1', 20, 'cepillo de mano de excelente calidad!', 'cepillo_manos.png', 8, 0),
(27, 1, 'Cepillo Tipo Plancha', '1', 20, 'Cepillo Tipo Plancha ideal para cualquier tipo de superficie!', 'cepillo_plancha.png', 12, 0),
(28, 1, 'Cubeta Flexible', '1', 20, 'Cubeta Flexible de alta capacidad, idenea para labores del hogar', 'cubeta_flexible.png', 12, 0),
(29, 1, 'Desengrasante de 650ml Brasso', '1', 20, 'Desengrasante marca Brasso de 650ml en formto de atomizador', 'desengrasante_650ml.png', 26, 0),
(30, 1, 'Desengrasante en Polvo Axion', '1', 20, 'Desengrasante en polvo de marac Axion de 425 grms ', 'detergente_425grms.png', 23, 0),
(31, 1, 'Escoba', '1', 20, 'Escoba de alta calidad, con cerdas ultra ressitentes a cualquier tipo de superficie', 'escoba.png', 18, 0),
(32, 1, 'Estropajo', '1', 20, 'Estropajo de la marca saluk, excelnete para antes y durante el baño', 'estropajo.png', 12, 0),
(33, 1, 'Fabuloso 1Lt', '1', 19, 'El unico y original fabuloso!, en su presentaccion de 1lt que desinfecta y elimina hasta el 99% de las bacterias!', 'fabuloso_1lt.png', 22, 0),
(34, 1, 'Guantes de Hule\r\n', '1', 20, 'Guantes de Hule de alta resistencia para la hora del aseo del hogar!', 'guantes_hule.png', 22, 0),
(36, 1, 'Jalador', '1', 20, 'Jalador ideal para cualquier tipo de piso y azulejo!', 'jalador.png', 25, 0),
(37, 1, 'Pinzas para ropa', '1', 20, 'Pinzas para colgar la ropa en el tendedero!', 'pinzas.png', 25, 0),
(38, 0, 'Cloro', '1', 52, 'desinfectante de la marca cloro ideal para desinfectar pisos y azulejos', 'cloro.jpg', 52, 1),
(39, 0, 'Escoba', '1', 50, 'Escobas de cerda gruesa ideal para el uso rudo ', 'escoba.jpg', 23, 1),
(40, 0, 'Esponja', '1', 100, 'Esponja multiusos ideal para limpiar cualquier tipo de superficie', 'esponjas.jpg', 12, 1),
(41, 0, 'Fabuloso', '1', 50, 'Fabuloso multiusos limpia todas las superficies eliminando el 99.99% de bacterias!', 'fabuloso.jpg', 23, 1),
(42, 0, 'Gel ', '1', 20, 'Gel desinfectante elimina el 99% de las bacterias.', 'gel.jpg', 118, 1),
(43, 0, 'Trapos', '1', 12, 'Trapos de microfibra ideal para limpiar cualquier superficie', 'trapos.jpg', 12, 1);
